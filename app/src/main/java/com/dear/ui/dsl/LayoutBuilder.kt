 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.ConstraintLayoutDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.FrameLayoutDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.ViewFlipperDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.EditTextDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.HorizontalScrollViewDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.ViewPager2DSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ViewGroup.FragmentContainerViewDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ConstraintLayout.GuidelineDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
    init: Guideline.() -> Unit
): Guideline {
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ConstraintLayout.BarrierDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
    init: Barrier.() -> Unit
): Barrier {
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ConstraintLayout.FlowDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
    init: Flow.() -> Unit
): Flow {
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun ConstraintLayout.LayerDSL(
    style: Int? = null,
    autoAdd: Boolean = true,
    init: Layer.() -> Unit
): Layer {
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ConstraintLayoutDSL(
    style: Int? = null,
    init: ConstraintLayout.() -> Unit
): ConstraintLayout {
    val constraintLayout =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.LinearLayoutDSL(
    style: Int? = null,
    init: LinearLayout.() -> Unit
): LinearLayout {
    val LinearLayout =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.FrameLayoutDSL(style: Int? = null, init: FrameLayout.() -> Unit): FrameLayout {
    val frameLayout =
        if (style != null) FrameLayout(
            ContextThemeWrapper(this, style)
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.NestedScrollViewDSL(
    style: Int? = null,
    init: NestedScrollView.() -> Unit
): NestedScrollView {
    val nestedScrollView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.TextViewDSL(
    style: Int? = null,
    init: AppCompatTextView.() -> Unit
): AppCompatTextView {
    val textView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ButtonDSL(style: Int? = null, init: AppCompatButton.() -> Unit): AppCompatButton {
    val button =
        if (style != null) AppCompatButton(
            ContextThemeWrapper(this, style)
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ImageViewDSL(
    style: Int? = null,
    init: AppCompatImageView.() -> Unit
): AppCompatImageView {
    val imageView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ViewDSL(style: Int? = null, init: View.() -> Unit): View {
    val view =
        if (style != null) View(
            ContextThemeWrapper(this, style)
        ) else View(this)
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.EditTextDSL(
    style: Int? = null,
    init: AppCompatEditText.() -> Unit
): AppCompatEditText {
    val editText =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ViewFlipperDSL(style: Int? = null, init: ViewFlipper.() -> Unit): ViewFlipper {
    val viewFlipper =
        if (style != null) ViewFlipper(
            ContextThemeWrapper(this, style)
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.HorizontalScrollViewDSL(
    style: Int? = null,
    init: HorizontalScrollView.() -> Unit
): HorizontalScrollView {
    val horizontalScrollView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.ViewPager2DSL(
    style: Int? = null,
    init: ViewPager2.() -> Unit
): ViewPager2 {
    val viewPager2 =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.RecyclerViewDSL(
    style: Int? = null,
    init: RecyclerView.() -> Unit
): RecyclerView {
    val recyclerView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Context.FragmentContainerViewDSL(
    style: Int? = null,
    init: FragmentContainerView.() -> Unit
): FragmentContainerView {
    val fragmentContainerView =
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.ConstraintLayoutDSL(
    style: Int? = null,
    init: ConstraintLayout.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.LinearLayoutDSL(
    style: Int? = null,
    init: LinearLayout.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.FrameLayoutDSL(
    style: Int? = null,
    init: FrameLayout.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.NestedScrollViewDSL(
    style: Int? = null,
    init: FrameLayout.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.TextViewDSL(
    style: Int? = null,
    init: AppCompatTextView.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.ImageViewDSL(
    style: Int? = null,
    init: AppCompatImageView.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.ViewFlipperDSL(
    style: Int? = null,
    init: ViewFlipper.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.EditTextDSL(
    style: Int? = null,
    init: AppCompatEditText.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.HorizontalScrollViewDSL(
    style: Int? = null,
    init: HorizontalScrollView.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.ViewPager2DSL(
    style: Int? = null,
    init: ViewPager2.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.RecyclerViewDSL(
    style: Int? = null,
    init: RecyclerView.() -> Unit
 ...
 * @param init set attributes for this view in this lambda
 */
inline fun Fragment.FragmentContainerViewDSL(
    style: Int? = null,
    init: FragmentContainerView.() -> Unit
