...
public class ConstraintSetBuild {
    ...
    public class ConstraintBegin {
         ...
         *
         * @param viewId 控件id
         * @param autor 方向 1.左 2.右 3.上 4.下 5.非法 6.start 7.end
         * @param value px
         * @return
         */
        public ConstraintBegin setGoneMargin(@IdRes int viewId,int autor,int value) {
            applyConstraintSet.setGoneMargin(viewId,autor,value);
            return this;
        }
        /**
         * 设置控件关系
         ...
         * @return
         */
        public ConstraintBegin setVerticalChainStyle(@IdRes int viewId,int style) {
            applyConstraintSet.setVerticalChainStyle(viewId,style);
            return this;
        }
         ...
         * @return
         */
        public ConstraintBegin setHorizontalChainStyle(@IdRes int viewId,int style) {
            applyConstraintSet.setHorizontalChainStyle(viewId,style);
            return this;
        }
         ...
         * @return
         */
        public ConstraintBegin setPercentWidth(@IdRes int viewId, float percent) {
         ...
         * @return
         */
        public ConstraintBegin setPercentHeight(@IdRes int viewId, float percent) {
